...
/*
<fileupload-img param="callBK:..."></fileupload-img>
*/

	/*
<file-up params="callBK:..."></daterange-picker>
*/
define(['knockout','jquery',  "common","text!js/widgets/kocomponent/fileupload/fileupImgReadonly.tpl.html","ajaxfileuploadamd"],function(ko,$,Common,template,interface_file){
	var newImgDatas ;
	var initImgDatas;
	var dataId; 
	var crossUrl = window.fileuploadurl;
	ko.components.register('fileupload-img-readonly', {
